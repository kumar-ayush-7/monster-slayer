function getRandomAttValue(max,min){
...
const app = Vue.createApp({
    ...
    methods: {
        attackMonster() {
            this.currentRound++;
            const attackValue = getRandomAttValue(12,5);
            this.monsterHealth -= attackValue;
            this.addLogMessages('player','attack', attackValue);
            this.attackPlayer();
        },
        attackPlayer() {
            const attackValue = getRandomAttValue(15,10);
            this.playerHealth -= attackValue;
            this.addLogMessages('monster','attack', attackValue);
        },
        specialAttack() {
            this.currentRound++;
            const attackValue = getRandomAttValue(20,15);
            this.monsterHealth -= attackValue;
            this.addLogMessages('player','attack', attackValue);
            this.attackPlayer();
        },
        healPlayer() {
            this.currentRound++;
            const healValue = getRandomAttValue(17,10);
